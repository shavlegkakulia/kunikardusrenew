...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "kunicardus.Android.dll" comes first in this list. */
		"kunicardus.Android.dll",
		"FormsViewGroup.dll",
		"Kunicardus.Core.dll",
		...
		"MvvmCross.Plugin.Accelerometer.dll",
		"MvvmCross.Plugin.All.dll",
		"MvvmCross.Plugin.Color.dll",
		"MvvmCross.Plugin.Email.dll",
		...
		"MvvmCross.Plugin.MethodBinding.dll",
		"MvvmCross.Plugin.PhoneCall.dll",
		"MvvmCross.Plugin.PictureChooser.dll",
		"MvvmCross.Plugin.ResourceLoader.dll",
		"MvvmCross.Plugin.ResxLocalization.dll",
		"MvvmCross.Plugin.Share.dll",
		"MvvmCross.Plugin.Visibility.dll",
		"MvvmCross.Plugin.WebBrowser.dll",
		"Newtonsoft.Json.dll",
		"SQLite-net.dll",
