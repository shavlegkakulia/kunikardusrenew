...
namespace Kunicardus.Core.Converters
{
	...
	public class NewsIsReadColorConverter : MvxColorValueConverter
	{
		protected override System.Drawing.Color Convert (object value, object parameter, CultureInfo culture)
		{
			...
			if (isRead) {
				return System.Drawing.Color.FromArgb(146, 145, 145);
			} else {
	...
	public class iOSValidationColorValueConverter : MvxColorValueConverter
	{
		...
		{			
			if (ShouldValidate && (value == null || string.IsNullOrWhiteSpace (value.ToString ()))) {
				// red;
				return System.Drawing.Color.FromArgb(255, 109, 64);
			} else {
				// green
//				if (!_shoudlValidate) {
//					_shoudlValidate = true;
//				}
				return System.Drawing.Color.FromArgb(185, 240, 80);
			}						
		}
	}
